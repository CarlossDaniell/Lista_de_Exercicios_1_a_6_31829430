...
namespace Lista_de_Exercicios_1_a_6
{
    class Program
    {
        ...
        {
            #region Exercicio 1
            //1. Uma empresa quer transmitir dados pelo telefone, mas está preocupada com ainterceptação telefônica.
            //Todos os seus dados são transmitidos como inteiros de quatro dígitos.
            //Ela pediu para que você escreva um programa que criptografe seus dados, para
            ...
            //Módulo de 10 no primeiro digito
            //Vamos criar a variavel temporario1 que sera entrada dividido por 1000

            int temporario1 = Entrada / 1000;
            //Agora obtemos o resto da divisão de entrada por 1000

            int resto1 = Entrada % 1000;
            //Agora atribuimos o valor numero1 como a divisao da entrada por 1000

            int numero1 = temporario1;

            //Vamos agora obter o segundo digito
            //Vamos atribuir o valor temporario 2 que sera o valor de resto1 dividido por 100

            int temporario2 = resto1 / 100;
            //Vamos agora atribuir o resto do valor 

            int resto2 = resto1 % 100;
            //Vamos ter a variável numero2 que sera igual a variavel temporario2

            int numero2 = temporario2;

            //Agora vamos obter o terceiro digito
            //Vamos atribuir o valor temporario 3 que sera o valor de resto 2 / 10
            ...
            //Fazendo agora a parte da soma da criptografia
            ...
            #region Exercicio 3
            //Implemente em C# a função booleana Par que retorna verdadeiro se um número inteiro passado como parâmetro for par ou falso caso ele seja ímpar.
